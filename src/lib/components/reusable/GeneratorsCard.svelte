...
<div class="card pb-10 bt-primary-500 bg-gradient-to-b from-surface-700 to-surface-900 w-9/12 lg:w-auto max-w-lg text-center">
    ...
    {#if generator === generators.CONVENTION}
        ...
        <div class="p-8 gap-4 flex flex-col items-center gap-7">
            <img src="/images/generator-1.png" class="w-10/12" alt="Infographic depicting how a conventions generator looks">
    ...
    {:else if generator === generators.CONTRIBUTION}
        ...
        <div class="p-8 gap-4 flex flex-col items-center gap-7">
            <img src="/images/generator-1.png" class="w-10/12" alt="Infographic depicting how a contributions generator looks">
    ...
    {:else if generator === generators.ISSUE}
        ...
        <div class="p-8 gap-4 flex flex-col items-center gap-7">
            <img src="/images/generator-3.png" class="w-10/12" alt="Infographic depicting how a pull-requests-template generator looks">
